...
def generar_respuesta(texto, number):
    if "hola" in texto:
        return {
            ...
            "to": number,
            "type": "text",
            "text": {"preview_url": False, "body": "🚀 Hola, ¿Cómo estás? Bienvenido."}
        }
    elif "1" in texto:
        return {
            "messaging_product": "whatsapp",
            ...
            "to": number,
            "type": "text",
            "text": {"preview_url": False, "body": "Información del curso."}
        }
    else:
        return {
            "messaging_product": "whatsapp",
            ...
            "to": number,
            "type": "text",
            "text": {"preview_url": False, "body": "Ingresa un número válido."}
        }